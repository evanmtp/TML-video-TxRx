...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 255.0, 15.0, 151.0, 20.0 ],
					"text" : "udpreceive 10044 CNMAT"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 120.0, 192.0, 20.0 ],
					"text" : "udpsend 127.0.0.1 67893 CNMAT"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 15.0, 30.0, 214.0, 20.0 ],
					"text" : "o4.net_recv \"control - from iPad\" 8881"
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 264.5, 84.5, 219.5, 84.5 ],
					"source" : [ "obj-5", 0 ]
				}
